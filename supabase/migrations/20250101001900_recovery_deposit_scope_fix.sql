...
begin
  ...
  insert into public.cash_deposits(agent_id,total_amount_pkr,deposit_slip_url,notes,created_by_user_id) values(v_agent_id,p_total_amount_pkr,p_deposit_slip_url,nullif(trim(p_notes),''),auth.uid()) returning id into deposit_id;
